...
SMA_URL = "https://api.polygon.io/v1/indicators/sma/SPY?timestamp.gte={start_time}&timestamp.lte={end_time}&timespan=minute&adjusted=true&window=20&series_type=close&order=desc&apiKey={api_key}&limit=5000"

EMA_URL = "https://api.polygon.io/v1/indicators/ema/SPY?timestamp.gte={start_time}&timestamp.lte={end_time}&timespan=minute&adjusted=true&window=20&series_type=close&order=desc&apiKey={api_key}&limit=5000"

MACD_URL = "https://api.polygon.io/v1/indicators/macd/SPY?timestamp.gte={start_time}&timestamp.lte={end_time}&timespan=minute&adjusted=true&short_window=12&long_window=26&signal_window=9&series_type=close&order=desc&apiKey={api_key}&limit=5000"

RSI_URL = "https://api.polygon.io/v1/indicators/rsi/SPY?timestamp.gte={start_time}&timestamp.lte={end_time}&timespan=minute&adjusted=true&window=14&series_type=close&order=desc&apiKey={api_key}&limit=5000"
